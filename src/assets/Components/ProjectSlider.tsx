...
const ProjectSlider: FC = () => {
	...
	return (
		<div className={styles.slider} ref={SliderRef}>
			<h1 data-aos="flip-left" data-aos-easing="ease-out" data-aos-delay="1">
				My Projects
			</h1>
			<p data-aos="flip-left" data-aos-easing="ease-out" data-aos-delay="300">
				Here's a brief showcase of some projects with a Live Demo and the Source
				Code.
			</p>
			<h5 data-aos="flip-left" data-aos-easing="ease-out" data-aos-delay="300">
